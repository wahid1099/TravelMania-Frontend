...
const UseFirebase = () => {
    ...
    const [userverifed,setuservirifed]=useState(false);
    ...
    useEffect(() => {
        fetch(`https://frozen-woodland-36161.herokuapp.com/users/${user.email}`)
            .then(res => res.json())
    ...
    const saveUser=(email,displayName,method)=>{
        ...
        console.log(user);
        fetch('https://frozen-woodland-36161.herokuapp.com/users',{
            method:method,
            headers:{
